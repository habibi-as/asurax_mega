...
const gameData = games["fear-around"];
const themeName = "fear-around";

export default function GameFearAround() {
  const conceptMedia = loadLocalConceptMedia(
    import.meta.glob('../../../assets/games/fear_around/concept_art/*.{jpg,jpeg,png,webp,mp4,webm,mov}', { eager: true })
  );
  return (
