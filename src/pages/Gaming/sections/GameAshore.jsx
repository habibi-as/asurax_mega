...
const gameData = games["the-last-signal"];
const themeName = "ashore";

export default function GameAshore() {
  const conceptMedia = loadLocalConceptMedia(
    import.meta.glob('../../../assets/games/ashore/concept_art/*.{jpg,jpeg,png,webp,mp4,webm,mov}', { eager: true })
  );
  return (
