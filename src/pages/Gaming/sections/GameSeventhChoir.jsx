...
const gameData = games["seventh-choir"];
const themeName = "seventh-choir";

export default function GameSeventhChoir() {
  const conceptMedia = loadLocalConceptMedia(
    import.meta.glob('../../../assets/games/seventh_choir/concept_art/*.{jpg,jpeg,png,webp,mp4,webm,mov}', { eager: true })
  );
  return (
