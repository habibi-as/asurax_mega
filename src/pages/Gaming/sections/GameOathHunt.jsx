...
const gameData = games["oath-hunt"];
const themeName = "oath-hunt";

export default function GameOathHunt() {
  const conceptMedia = loadLocalConceptMedia(
    import.meta.glob('../../../assets/games/oath_hunt/concept_art/*.{jpg,jpeg,png,webp,mp4,webm,mov}', { eager: true })
  );
  return (
